...
class UsersPage(BaseScreen1):
    ...
    async def build(self):
        make_code("{}://user_{}".format(self.prog.config.APPNAMELINK, self.app.session["id"]), userdata_path=self.prog.config.USERDATA_DIR).save("{}/shaire.png".format(self.prog.config.USERDATA_PATH))
